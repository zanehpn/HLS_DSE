...
#pragma HLS pipeline off  // set_directive_pipeline -off stencil3d/row_bound_height
...
#pragma HLS pipeline off  // set_directive_pipeline -off stencil3d/row_bound_col
