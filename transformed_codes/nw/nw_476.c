...
#pragma HLS array_partition variable=M type=cyclic factor=2 dim=1 // set_directive_array_partition -factor 2 -type cyclic needwun M
...
#pragma HLS array_partition variable=SEQA type=block factor=2 dim=1 // set_directive_array_partition -factor 2 -type block needwun SEQA
