...
{
#pragma HLS inline on// set_directive_inline local_scan
    int radixID, i, bucket_indx;
// set_directive_bind_op -op mul -impl fabric -latency -1 local_scan/local_2 bucket_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
    for (radixID=0; radixID<SCAN_RADIX; radixID++) {
// set_directive_bind_op -op add -impl dsp -latency -1 local_scan/local_1 radixID  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
#pragma HLS pipeline style=stp  // set_directive_pipeline -style stp local_scan/local_1
#pragma HLS unroll factor=2  // set_directive_unroll -factor 2 local_scan/local_1
...
{
#pragma HLS inline recursive  // set_directive_inline -recursive sum_scan
...
#pragma HLS unroll factor=2  // set_directive_unroll -factor 2 sum_scan/sum_1
...
{
#pragma HLS inline off  // set_directive_inline -off last_step_scan
    int radixID, i, bucket_indx;
// set_directive_bind_op -op mul -impl fabric -latency -1 last_step_scan/last_2 bucket_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
    for (radixID=0; radixID<SCAN_RADIX; radixID++) {
#pragma HLS bind_op variable=radixID op=add impl=dsp latency=True  // set_directive_bind_op -op add -impl dsp -latency -1 last_step_scan/last_1 radixID
// set_directive_bind_op -op add -impl dsp -latency -1 last_step_scan/last_1 radixID  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
// set_directive_loop_flatten last_step_scan/last_1  // (no mapping available)
        for (i=0; i<SCAN_BLOCK; i++) {
// set_directive_bind_op -op add -impl dsp -latency -1 last_step_scan/last_2 i  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
...
{
#pragma HLS inline off  // set_directive_inline -off init
    int i;
...
{
#pragma HLS inline recursive  // set_directive_inline -recursive hist
    int blockID, i, bucket_indx, a_indx;
// set_directive_bind_op -op mul -impl fabric -latency -1 hist/hist_2 a_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
// set_directive_bind_op -op mul -impl fabric -latency -1 hist/hist_2 bucket_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
    blockID = 0;
    for (blockID=0; blockID<NUMOFBLOCKS; blockID++) {
// set_directive_bind_op -op add -impl fabric -latency -1 hist/hist_1 blockID  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
#pragma HLS pipeline off  // set_directive_pipeline -off hist/hist_1
#pragma HLS unroll factor=2  // set_directive_unroll -factor 2 hist/hist_1
...
#pragma HLS pipeline style=stp  // set_directive_pipeline -style stp hist/hist_2
...
{
#pragma HLS inline recursive  // set_directive_inline -recursive update
    int i, blockID, bucket_indx, a_indx;
#pragma HLS bind_op variable=a_indx op=mul impl=dsp latency=True  // set_directive_bind_op -op mul -impl dsp -latency -1 update/update_2 a_indx
// set_directive_bind_op -op mul -impl dsp -latency -1 update/update_2 a_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
...
// set_directive_bind_op -op mul -impl dsp -latency -1 update/update_2 bucket_indx  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
    ...
    for (blockID = 0; blockID < NUMOFBLOCKS; blockID++) {
#pragma HLS bind_op variable=blockID op=add impl=dsp latency=True  // set_directive_bind_op -op add -impl dsp -latency -1 update/update_1 blockID
// set_directive_bind_op -op add -impl dsp -latency -1 update/update_1 blockID  // (verify mapping - tool-specific; you may need to replace with RESOURCE/ALLOCATION pragma)
...
#pragma HLS pipeline style=stp  // set_directive_pipeline -style stp update/update_2
...
#pragma HLS array_reshape variable=sum type=cyclic factor=2 dim=1  // set_directive_array_reshape -factor 2 -type cyclic ss_sort sum
#pragma HLS array_reshape variable=bucket type=block factor=2 dim=1  // set_directive_array_reshape -factor 2 -type block ss_sort bucket
...
#pragma HLS array_partition variable=a type=cyclic factor=2 dim=1 // set_directive_array_partition -factor 2 -type cyclic ss_sort a
    int exp=0;
    int valid_buffer=0;
    #define BUFFER_A 0
    #define BUFFER_B 1
