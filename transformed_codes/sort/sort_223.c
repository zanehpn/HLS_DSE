...
#pragma HLS pipeline style=stp  // set_directive_pipeline -style stp last_step_scan/last_1
...
#pragma HLS array_reshape variable=b type=cyclic factor=2 dim=1  // set_directive_array_reshape -factor 2 -type cyclic ss_sort b
