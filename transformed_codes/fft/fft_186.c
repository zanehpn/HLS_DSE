...
#pragma HLS array_partition variable=img_twid type=block factor=2 dim=1 // set_directive_array_partition -factor 2 -type block fft img_twid
#pragma HLS array_reshape variable=img type=cyclic factor=2 dim=1  // set_directive_array_reshape -factor 2 -type cyclic fft img
#pragma HLS array_partition variable=img type=cyclic factor=2 dim=1 // set_directive_array_partition -factor 2 -type cyclic fft img
#pragma HLS array_reshape variable=real type=block factor=2 dim=1  // set_directive_array_reshape -factor 2 -type block fft real
#pragma HLS array_partition variable=real type=cyclic factor=2 dim=1 // set_directive_array_partition -factor 2 -type cyclic fft real
...
#pragma HLS pipeline off  // set_directive_pipeline -off fft/inner
            odd |= span;
            even = odd ^ span;
