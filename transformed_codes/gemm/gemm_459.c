...
#pragma HLS array_partition variable=prod type=block factor=2 dim=1 // set_directive_array_partition -factor 2 -type block gemm prod
...
#pragma HLS array_partition variable=m1 type=cyclic factor=2 dim=1 // set_directive_array_partition -factor 2 -type cyclic gemm m1
    int i, j, k;
    int k_col, i_col;
...
#pragma HLS pipeline style=stp  // set_directive_pipeline -style stp gemm/inner
                k_col = k * col_size;
