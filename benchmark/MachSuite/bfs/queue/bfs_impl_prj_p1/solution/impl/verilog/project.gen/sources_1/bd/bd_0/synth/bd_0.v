...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_0_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_0_ADDRESS0, LAYERED_METADATA undef" *) output [6:0]level_0_address0;
  output level_0_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_0_D0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_0_D0, LAYERED_METADATA undef" *) output [7:0]level_0_d0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_0_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_0_Q0, LAYERED_METADATA undef" *) input [7:0]level_0_q0;
  output level_0_we0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_1_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_1_ADDRESS0, LAYERED_METADATA undef" *) output [6:0]level_1_address0;
  output level_1_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_1_D0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_1_D0, LAYERED_METADATA undef" *) output [7:0]level_1_d0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.LEVEL_1_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.LEVEL_1_Q0, LAYERED_METADATA undef" *) input [7:0]level_1_q0;
  output level_1_we0;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.NODES_0_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.NODES_0_ADDRESS0, LAYERED_METADATA undef" *) output [5:0]nodes_0_address0;
  output nodes_0_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.NODES_0_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.NODES_0_Q0, LAYERED_METADATA undef" *) input [255:0]nodes_0_q0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.NODES_1_ADDRESS0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.NODES_1_ADDRESS0, LAYERED_METADATA undef" *) output [5:0]nodes_1_address0;
  output nodes_1_ce0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.NODES_1_Q0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.NODES_1_Q0, LAYERED_METADATA undef" *) input [255:0]nodes_1_q0;
  ...
  wire [6:0]hls_inst_level_0_address0;
  wire hls_inst_level_0_ce0;
  wire [7:0]hls_inst_level_0_d0;
  wire hls_inst_level_0_we0;
  wire [6:0]hls_inst_level_1_address0;
  wire hls_inst_level_1_ce0;
  wire [7:0]hls_inst_level_1_d0;
  wire hls_inst_level_1_we0;
  ...
  wire [5:0]hls_inst_nodes_0_address0;
  wire hls_inst_nodes_0_ce0;
  wire [5:0]hls_inst_nodes_1_address0;
  wire hls_inst_nodes_1_ce0;
  wire [7:0]level_0_q0_0_1;
  wire [7:0]level_1_q0_0_1;
  wire [127:0]level_counts_0_q0_0_1;
  wire [127:0]level_counts_1_q0_0_1;
  wire [255:0]nodes_0_q0_0_1;
  wire [255:0]nodes_1_q0_0_1;
  ...
  assign level_0_address0[6:0] = hls_inst_level_0_address0;
  assign level_0_ce0 = hls_inst_level_0_ce0;
  assign level_0_d0[7:0] = hls_inst_level_0_d0;
  assign level_0_q0_0_1 = level_0_q0[7:0];
  assign level_0_we0 = hls_inst_level_0_we0;
  assign level_1_address0[6:0] = hls_inst_level_1_address0;
  assign level_1_ce0 = hls_inst_level_1_ce0;
  assign level_1_d0[7:0] = hls_inst_level_1_d0;
  assign level_1_q0_0_1 = level_1_q0[7:0];
  assign level_1_we0 = hls_inst_level_1_we0;
  ...
  assign nodes_0_address0[5:0] = hls_inst_nodes_0_address0;
  assign nodes_0_ce0 = hls_inst_nodes_0_ce0;
  assign nodes_0_q0_0_1 = nodes_0_q0[255:0];
  assign nodes_1_address0[5:0] = hls_inst_nodes_1_address0;
  assign nodes_1_ce0 = hls_inst_nodes_1_ce0;
  assign nodes_1_q0_0_1 = nodes_1_q0[255:0];
  ...
  bd_0_hls_inst_0 hls_inst
       (.ap_clk(ap_clk_0_1),
        ...
        .level_0_address0(hls_inst_level_0_address0),
        .level_0_ce0(hls_inst_level_0_ce0),
        .level_0_d0(hls_inst_level_0_d0),
        .level_0_q0(level_0_q0_0_1),
        .level_0_we0(hls_inst_level_0_we0),
        .level_1_address0(hls_inst_level_1_address0),
        .level_1_ce0(hls_inst_level_1_ce0),
        .level_1_d0(hls_inst_level_1_d0),
        .level_1_q0(level_1_q0_0_1),
        .level_1_we0(hls_inst_level_1_we0),
        ...
        .nodes_0_address0(hls_inst_nodes_0_address0),
        .nodes_0_ce0(hls_inst_nodes_0_ce0),
        .nodes_0_q0(nodes_0_q0_0_1),
        .nodes_1_address0(hls_inst_nodes_1_address0),
        .nodes_1_ce0(hls_inst_nodes_1_ce0),
        .nodes_1_q0(nodes_1_q0_0_1),
