...
{
#pragma HLS array_partition variable=buf cyclic factor=2  // set_directive_array_partition -factor 2 -type cyclic aes256_encrypt_ecb buf
#pragma HLS array_partition variable=k cyclic factor=2  // set_directive_array_partition -factor 2 -type cyclic aes256_encrypt_ecb k
    //INIT
    uint8_t rcon = 1;
    uint8_t i;
