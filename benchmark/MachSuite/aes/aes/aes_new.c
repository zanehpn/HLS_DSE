...
{
#pragma HLS array_partition variable=buf type=cyclic factor=2  // set_directive_array_partition -factor 2 -type cyclic aes256_encrypt_ecb buf
#pragma HLS array_partition variable=k type=cyclic factor=2  // set_directive_array_partition -factor 2 -type cyclic aes256_encrypt_ecb k
    //INIT
    uint8_t rcon = 1;
    uint8_t i;
