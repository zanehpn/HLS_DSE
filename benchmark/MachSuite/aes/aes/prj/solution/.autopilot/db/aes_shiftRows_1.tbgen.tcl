set moduleName aes_shiftRows_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_shiftRows.1}
...
set Spec2ImplPortList { 
	buf_0 { ap_memory {  { buf_0_address0 mem_address 1 2 }  { buf_0_ce0 mem_ce 1 1 }  { buf_0_we0 mem_we 1 1 }  { buf_0_d0 mem_din 1 16 }  { buf_0_q0 mem_dout 0 16 }  { buf_0_address1 MemPortADDR2 1 2 }  { buf_0_ce1 MemPortCE2 1 1 }  { buf_0_we1 MemPortWE2 1 1 }  { buf_0_d1 MemPortDIN2 1 16 }  { buf_0_q1 in_data 0 16 } } }
	buf_1 { ap_memory {  { buf_1_address0 mem_address 1 2 }  { buf_1_ce0 mem_ce 1 1 }  { buf_1_we0 mem_we 1 1 }  { buf_1_d0 mem_din 1 16 }  { buf_1_q0 mem_dout 0 16 }  { buf_1_address1 MemPortADDR2 1 2 }  { buf_1_ce1 MemPortCE2 1 1 }  { buf_1_we1 MemPortWE2 1 1 }  { buf_1_d1 MemPortDIN2 1 16 }  { buf_1_q1 in_data 0 16 } } }
}
