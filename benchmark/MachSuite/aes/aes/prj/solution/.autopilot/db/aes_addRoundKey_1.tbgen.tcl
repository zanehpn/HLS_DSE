set moduleName aes_addRoundKey_1
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "buf_0", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "key_idx", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ p_read sc_in sc_lv 768 signal 2 } 
	{ key_idx sc_in sc_lv 8 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "key_idx", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "key_idx", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	key_idx { ap_none {  { key_idx in_data 0 8 } } }
}
