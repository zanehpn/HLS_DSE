...
set C_modelArgList {
	...
	{ p_out int 768 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ctx_load", "interface" : "wire", "bitwidth" : 768, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "p_out", "interface" : "wire", "bitwidth" : 768, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ p_out sc_out sc_lv 768 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "p_out", "direction": "out", "datatype": "sc_lv", "bitwidth":768, "type": "signal", "bundle":{"name": "p_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_8_1_1_U2", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	k_0 { ap_memory {  { k_0_address0 mem_address 1 3 }  { k_0_ce0 mem_ce 1 1 }  { k_0_q0 in_data 0 16 }  { k_0_address1 MemPortADDR2 1 3 }  { k_0_ce1 MemPortCE2 1 1 }  { k_0_q1 in_data 0 16 } } }
	k_1 { ap_memory {  { k_1_address0 mem_address 1 3 }  { k_1_ce0 mem_ce 1 1 }  { k_1_q0 in_data 0 16 }  { k_1_address1 MemPortADDR2 1 3 }  { k_1_ce1 MemPortCE2 1 1 }  { k_1_q1 in_data 0 16 } } }
	p_out { ap_vld {  { p_out out_data 1 768 }  { p_out_ap_vld out_vld 1 1 } } }
}
