set moduleName last_step_scan_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {last_step_scan.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket_0 int 64 regular {array 512 { 2 3 } 1 1 }  }
	{ bucket_1 int 64 regular {array 512 { 2 3 } 1 1 }  }
	{ sum_0 int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ sum_1 int 64 regular {array 32 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bucket_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	...
 	{ "Name" : "sum_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sum_1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sum_0_address0 sc_out sc_lv 5 signal 2 } 
	{ sum_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ sum_0_q0 sc_in sc_lv 64 signal 2 } 
	{ sum_1_address0 sc_out sc_lv 5 signal 3 } 
	{ sum_1_ce0 sc_out sc_logic 1 signal 3 } 
	{ sum_1_q0 sc_in sc_lv 64 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_22_32_1_1_U39", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sum_0 { ap_memory {  { sum_0_address0 mem_address 1 5 }  { sum_0_ce0 mem_ce 1 1 }  { sum_0_q0 in_data 0 64 } } }
	sum_1 { ap_memory {  { sum_1_address0 mem_address 1 5 }  { sum_1_ce0 mem_ce 1 1 }  { sum_1_q0 in_data 0 64 } } }
}
