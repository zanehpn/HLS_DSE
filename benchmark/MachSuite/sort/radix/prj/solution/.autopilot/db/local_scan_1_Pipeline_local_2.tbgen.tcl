set moduleName local_scan_1_Pipeline_local_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {local_scan.1_Pipeline_local_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ zext_ln14 int 11 regular  }
	{ trunc_ln15_2 int 9 regular  }
	{ trunc_ln int 10 regular  }
	{ bucket_0 int 64 regular {array 512 { 2 1 } 1 1 }  }
	{ bucket_1 int 64 regular {array 512 { 2 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln14", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln15_2", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln14 sc_in sc_lv 11 signal 0 } 
	{ trunc_ln15_2 sc_in sc_lv 9 signal 1 } 
	{ trunc_ln sc_in sc_lv 10 signal 2 } 
	{ bucket_0_address0 sc_out sc_lv 9 signal 3 } 
	{ bucket_0_ce0 sc_out sc_logic 1 signal 3 } 
	{ bucket_0_we0 sc_out sc_logic 1 signal 3 } 
	{ bucket_0_d0 sc_out sc_lv 64 signal 3 } 
	{ bucket_0_q0 sc_in sc_lv 64 signal 3 } 
	{ bucket_0_address1 sc_out sc_lv 9 signal 3 } 
	{ bucket_0_ce1 sc_out sc_logic 1 signal 3 } 
	{ bucket_0_q1 sc_in sc_lv 64 signal 3 } 
	{ bucket_1_address0 sc_out sc_lv 9 signal 4 } 
	{ bucket_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ bucket_1_we0 sc_out sc_logic 1 signal 4 } 
	{ bucket_1_d0 sc_out sc_lv 64 signal 4 } 
	{ bucket_1_q0 sc_in sc_lv 64 signal 4 } 
	{ bucket_1_address1 sc_out sc_lv 9 signal 4 } 
	{ bucket_1_ce1 sc_out sc_logic 1 signal 4 } 
	{ bucket_1_q1 sc_in sc_lv 64 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln14", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "zext_ln14", "role": "default" }} , 
 	{ "name": "trunc_ln15_2", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "trunc_ln15_2", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_254_32_1_1_U12", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_254_32_1_1_U13", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_254_32_1_1_U14", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_254_32_1_1_U15", "Parent" : "0"},
...
set Spec2ImplPortList { 
	zext_ln14 { ap_none {  { zext_ln14 in_data 0 11 } } }
	trunc_ln15_2 { ap_none {  { trunc_ln15_2 in_data 0 9 } } }
	trunc_ln { ap_none {  { trunc_ln in_data 0 10 } } }
	bucket_0 { ap_memory {  { bucket_0_address0 mem_address 1 9 }  { bucket_0_ce0 mem_ce 1 1 }  { bucket_0_we0 mem_we 1 1 }  { bucket_0_d0 mem_din 1 64 }  { bucket_0_q0 in_data 0 64 }  { bucket_0_address1 MemPortADDR2 1 9 }  { bucket_0_ce1 MemPortCE2 1 1 }  { bucket_0_q1 in_data 0 64 } } }
	bucket_1 { ap_memory {  { bucket_1_address0 mem_address 1 9 }  { bucket_1_ce0 mem_ce 1 1 }  { bucket_1_we0 mem_we 1 1 }  { bucket_1_d0 mem_din 1 64 }  { bucket_1_q0 in_data 0 64 }  { bucket_1_address1 MemPortADDR2 1 9 }  { bucket_1_ce1 MemPortCE2 1 1 }  { bucket_1_q1 in_data 0 64 } } }
}
