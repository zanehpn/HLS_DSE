...
set portList { 
	...
	{ sol_0_address1 sc_out sc_lv 12 signal 0 } 
	{ sol_0_ce1 sc_out sc_logic 1 signal 0 } 
	{ sol_0_we1 sc_out sc_logic 1 signal 0 } 
	{ sol_0_d1 sc_out sc_lv 64 signal 0 } 
	{ sol_0_q1 sc_in sc_lv 64 signal 0 } 
	...
	{ sol_1_address1 sc_out sc_lv 12 signal 3 } 
	{ sol_1_ce1 sc_out sc_logic 1 signal 3 } 
	{ sol_1_we1 sc_out sc_logic 1 signal 3 } 
	{ sol_1_d1 sc_out sc_lv 64 signal 3 } 
	{ sol_1_q1 sc_in sc_lv 64 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mux_21_32_1_1_U16", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sol_0 { ap_memory {  { sol_0_address0 mem_address 1 12 }  { sol_0_ce0 mem_ce 1 1 }  { sol_0_we0 mem_we 1 1 }  { sol_0_d0 mem_din 1 64 }  { sol_0_q0 in_data 0 64 }  { sol_0_address1 MemPortADDR2 1 12 }  { sol_0_ce1 MemPortCE2 1 1 }  { sol_0_we1 MemPortWE2 1 1 }  { sol_0_d1 MemPortDIN2 1 64 }  { sol_0_q1 in_data 0 64 } } }
	...
	orig_1 { ap_memory {  { orig_1_address0 mem_address 1 12 }  { orig_1_ce0 mem_ce 1 1 }  { orig_1_q0 in_data 0 64 }  { orig_1_address1 MemPortADDR2 1 12 }  { orig_1_ce1 MemPortCE2 1 1 }  { orig_1_q1 in_data 0 64 } } }
	sol_1 { ap_memory {  { sol_1_address0 mem_address 1 12 }  { sol_1_ce0 mem_ce 1 1 }  { sol_1_we0 mem_we 1 1 }  { sol_1_d0 mem_din 1 64 }  { sol_1_q0 in_data 0 64 }  { sol_1_address1 MemPortADDR2 1 12 }  { sol_1_ce1 MemPortCE2 1 1 }  { sol_1_we1 MemPortWE2 1 1 }  { sol_1_d1 MemPortDIN2 1 64 }  { sol_1_q1 in_data 0 64 } } }
}
