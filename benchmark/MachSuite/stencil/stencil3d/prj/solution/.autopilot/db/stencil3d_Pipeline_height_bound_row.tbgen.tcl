set moduleName stencil3d_Pipeline_height_bound_row
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {stencil3d_Pipeline_height_bound_row}
set C_modelType { void 0 }
set C_modelArgList {
	{ tmp_52 int 9 regular  }
	{ orig_0 int 64 regular {array 4096 { 1 3 } 1 1 }  }
	{ sol_0 int 64 regular {array 4096 { 2 3 } 1 1 }  }
	{ zext_ln16 int 9 regular  }
	{ orig_1 int 64 regular {array 4096 { 1 3 } 1 1 }  }
	{ sol_1 int 64 regular {array 4096 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "tmp_52", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "orig_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "sol_0", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "zext_ln16", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ tmp_52 sc_in sc_lv 9 signal 0 } 
	{ orig_0_address0 sc_out sc_lv 12 signal 1 } 
	{ orig_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ orig_0_q0 sc_in sc_lv 64 signal 1 } 
	{ sol_0_address0 sc_out sc_lv 12 signal 2 } 
	{ sol_0_ce0 sc_out sc_logic 1 signal 2 } 
	{ sol_0_we0 sc_out sc_logic 1 signal 2 } 
	{ sol_0_d0 sc_out sc_lv 64 signal 2 } 
	{ sol_0_q0 sc_in sc_lv 64 signal 2 } 
	{ zext_ln16 sc_in sc_lv 9 signal 3 } 
	{ orig_1_address0 sc_out sc_lv 12 signal 4 } 
	{ orig_1_ce0 sc_out sc_logic 1 signal 4 } 
	{ orig_1_q0 sc_in sc_lv 64 signal 4 } 
	{ sol_1_address0 sc_out sc_lv 12 signal 5 } 
	{ sol_1_ce0 sc_out sc_logic 1 signal 5 } 
	{ sol_1_we0 sc_out sc_logic 1 signal 5 } 
	{ sol_1_d0 sc_out sc_lv 64 signal 5 } 
	{ sol_1_address1 sc_out sc_lv 12 signal 5 } 
	{ sol_1_ce1 sc_out sc_logic 1 signal 5 } 
	{ sol_1_q1 sc_in sc_lv 64 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "tmp_52", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "tmp_52", "role": "default" }} , 
 	...
 	{ "name": "zext_ln16", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "zext_ln16", "role": "default" }} , 
...
set Spec2ImplPortList { 
	tmp_52 { ap_none {  { tmp_52 in_data 0 9 } } }
	orig_0 { ap_memory {  { orig_0_address0 mem_address 1 12 }  { orig_0_ce0 mem_ce 1 1 }  { orig_0_q0 in_data 0 64 } } }
	...
	zext_ln16 { ap_none {  { zext_ln16 in_data 0 9 } } }
	orig_1 { ap_memory {  { orig_1_address0 mem_address 1 12 }  { orig_1_ce0 mem_ce 1 1 }  { orig_1_q0 in_data 0 64 } } }
	sol_1 { ap_memory {  { sol_1_address0 mem_address 1 12 }  { sol_1_ce0 mem_ce 1 1 }  { sol_1_we0 mem_we 1 1 }  { sol_1_d0 mem_din 1 64 }  { sol_1_address1 MemPortADDR2 1 12 }  { sol_1_ce1 MemPortCE2 1 1 }  { sol_1_q1 in_data 0 64 } } }
}
