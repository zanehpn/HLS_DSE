...
def train(model, train_loader):
    ...
    for batch in train_loader:
        ...
        total_mae += mae.item() * graph_data.num_graphs
...
def test(model, loader, epoch):
    ...
    with torch.no_grad():
        ...
        for graph_data, code_data in loader:
            ...
            mae += F.l1_loss(out, true_y[tar_idx]).float().item() * graph_data.num_graphs  # MAE
...
if __name__ == "__main__":
    ...
    for epoch in range(500):
        ...
        print(f'Epoch: {epoch:03d}, Train MAPE: {train_mae:.4f}, Test MAPE: {test_mae:.4f}')
    ...
    print('Min Train MAPE: ' + str(min_train_mae))
    print('Min Test MAPE: ' + str(min_test_mae))
